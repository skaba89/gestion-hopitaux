  ...
  return (
    <motion.div className="p-4 lg:p-6 max-w-[1600px] mx-auto" variants={containerVariants} initial="hidden" animate="visible">
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Paiements</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">Mobile Money, QR Code & Crédit Santé</p>
        </div>
      </motion.div>
