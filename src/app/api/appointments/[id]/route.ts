  ...
  return secureApiHandler(async (request: NextRequest, context: ApiHandlerContext) => {
    try {
      ...
      addSimpleAuditEntry({
        ...
        entity: 'Appointment',
        entityId: id,
        description: `Appointment ${id} updated by ${context.userName}`,
        severity: 'INFO',
    ...
    requireAuth: true,
    audit: { resource: 'appointments', action: 'UPDATE' },
  })(request)
}
  ...
  return secureApiHandler(async (request: NextRequest, context: ApiHandlerContext) => {
    try {
      ...
      addSimpleAuditEntry({
        ...
        entity: 'Appointment',
        entityId: id,
        description: `Appointment ${id} cancelled by ${context.userName}`,
        severity: 'WARNING',
        userId: context.userId,
        userName: context.userName,
        ip: context.ip,
    ...
    requireAuth: true,
    audit: { resource: 'appointments', action: 'DELETE' },
  })(request)
}
