...
export async function PUT(request: NextRequest) {
  try {
    ...
    const allowedFields = ['name', 'type', 'code', 'address', 'city', 'region', 'country', 'phone', 'email', 'logoUrl', 'isActive', 'parentId']
...
// DELETE /api/establishments - Soft delete (set isActive: false)
